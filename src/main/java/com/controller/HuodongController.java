...
public class HuodongController {
    ...
    @Autowired
    private NewsService newsService;//校园资讯
    @Autowired
...
//                            huodongEntity.setHuodongKucunNumber(Integer.valueOf(data.get(0)));   //活动最大参与人数 要改的
//                            huodongEntity.setZanNumber(Integer.valueOf(data.get(0)));   //赞 要改的
//                            huodongEntity.setCaiNumber(Integer.valueOf(data.get(0)));   //踩 要改的
//                            huodongEntity.setHuodongKaishiTime(sdf.parse(data.get(0)));          //活动开始时间 要改的
