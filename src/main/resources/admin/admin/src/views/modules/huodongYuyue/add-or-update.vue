    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="活动最大参与人数" prop="huodongKucunNumber">
                        <el-input v-model="huodongForm.huodongKucunNumber"
                                  placeholder="活动最大参与人数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="活动开始时间" prop="huodongKaishiTime">
                        <el-input v-model="huodongForm.huodongKaishiTime"
                                  placeholder="活动开始时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="活动开始时间" prop="huodongKaishiTime">
                            <el-input v-model="ruleForm.huodongKaishiTime"
